...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29500 \
    ...
    --embodiment_tag NEW_EMBODIMENT \
    --num_gpus $NUM_GPUS \
    --output_dir /mnt/sata1/gr00t16/g1_finetune/restock_yaw__bs32_lr1e4_shxep50000_g1 \
    --max_steps 10000 \
    --save_steps 1000 \
    --save-total-limit 3 \
    --warmup_ratio 0.05 \
...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29500 \
    ...
    --embodiment_tag NEW_EMBODIMENT \
    --num_gpus $NUM_GPUS \
    --output_dir /mnt/sata1/gr00t16/g1_finetune/restock_yaw_hand_IO__bs32_lr1e4_shxep50000_g1 \
    --max_steps 10000 \
    --save_steps 1000 \
    --save-total-limit 3 \
    --warmup_ratio 0.05 \
...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29500 \
    ...
    --embodiment_tag NEW_EMBODIMENT \
    --num_gpus $NUM_GPUS \
    --output_dir /mnt/sata1/gr00t16/g1_finetune/restock_yaw__bs32_lr1e4_shxep50000_g1_shs256 \
    --max_steps 10000 \
    --save_steps 1000 \
    --save-total-limit 3 \
    --warmup_ratio 0.05 \

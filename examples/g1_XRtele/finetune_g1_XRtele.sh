...
#     --dataset_path /mnt/sata1/gr00t16/HF_HOME/lerobot/rss-hiverobots/retail_restock_complete_v2 \
#     --modality_config_path examples/g1_XRtele_wristcams/modality_config.py \
#     --embodiment_tag NEW_EMBODIMENT \
#     --num_gpus $NUM_GPUS \
#     --output_dir /mnt/sata1/gr00t16/g1_finetune/restock__bs32_lr1e4_shxep10000 \
#     --save_total_limit 5 \
#     --max_steps 10000 \
#     --save_steps 1000 \
#     --save-total-limit 3 \
